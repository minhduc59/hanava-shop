-- CreateEnum
CREATE TYPE "public"."OrderStatusEnum" AS ENUM ('Processing', 'Shipped', 'Delivered', 'ReturnProcessing', 'ReturnCompleted', 'Cancelled', 'RefundProcessing', 'RefundCompleted', 'Denied');

-- CreateEnum
CREATE TYPE "public"."PaymentStatusEnum" AS ENUM ('Processing', 'Paid', 'Failed', 'Denied');
...
-- CreateTable
CREATE TABLE "public"."_BannerToCategory" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_BannerToCategory_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "User_emailUnsubscribeToken_key" ON "public"."User"("emailUnsubscribeToken");
...
-- CreateIndex
CREATE UNIQUE INDEX "Owner_phone_key" ON "public"."Owner"("phone");

-- CreateIndex
CREATE UNIQUE INDEX "Author_email_key" ON "public"."Author"("email");

-- CreateIndex
CREATE UNIQUE INDEX "Author_phone_key" ON "public"."Author"("phone");
...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_number_key" ON "public"."Payment"("number");

-- CreateIndex
CREATE UNIQUE INDEX "Payment_refId_key" ON "public"."Payment"("refId");
...
-- CreateIndex
CREATE UNIQUE INDEX "PaymentProvider_title_key" ON "public"."PaymentProvider"("title");

-- CreateIndex
CREATE INDEX "Error_userId_idx" ON "public"."Error"("userId");
...
-- CreateIndex
CREATE INDEX "_BannerToCategory_B_index" ON "public"."_BannerToCategory"("B");

-- AddForeignKey
ALTER TABLE "public"."Cart" ADD CONSTRAINT "Cart_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."CartItem" ADD CONSTRAINT "CartItem_cartId_fkey" FOREIGN KEY ("cartId") REFERENCES "public"."Cart"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Payment" ADD CONSTRAINT "Payment_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "public"."PaymentProvider"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Error" ADD CONSTRAINT "Error_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."_BannerToCategory" ADD CONSTRAINT "_BannerToCategory_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Banner"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_BannerToCategory" ADD CONSTRAINT "_BannerToCategory_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;
